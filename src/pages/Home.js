    ...
    <section className="row" id="bigbox">
      <div className="col-md-8">
        <article className="block" >
          ...
          <p id="pp">  iOS and Full-Stack Dev from Atlanta, GA. I am a very Young and Creative dev. At 20 I have had a app on the app store named "Brav0" and 4 websites for companies I have built in the past. I have a Certificate from "Big Nerd Ranch" for iOS Development and a Certificate from Georgia Tech for "Full Stack Development". I have a good sense of humor and I am very easy to work with. I want to eventually keep going down the Mobile route by learning React Native. I also have the ability to see projects from both perspectives. 
          </p>
          <br />
